...
import daily from "./presets/daily";
export type { FortuneWheelPreset, FortuneWheelSector } from "./types";

export const FORTUNE_WHEEL_PRESETS = { standard, supplies, daily };
...
export function isFortuneWheelPresetId(
  value: unknown,
): value is FortuneWheelPresetId {
  return (
    typeof value === "string" &&
    Object.prototype.hasOwnProperty.call(FORTUNE_WHEEL_PRESETS, value)
  );
}
