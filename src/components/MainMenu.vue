<template>
    <div class="container">
        ...
        <TransitionGroup name="business_tab_showing" tag="div" class="busines_tab_group">
            ...
            <div v-if="isMainMenuEnabled" :key="'fortune-wheel'" class="btn_container"
                :style="{ animationDelay: '0s' }">
                <div class="icon_container"
                    :class="{ 'icon_container--pulse': hasFortuneReward && showFortuneReminder }"
                    @click="businessButtons[0].action">
            ...
            <div v-if="isMainMenuEnabled" :key="'daily-tasks'" class="btn_container"
                :style="{ animationDelay: '0.2s' }">
                <div class="icon_container" :class="{ 'icon_container--pulse': hasQuestsReward && showQuestsReminder }"
                    @click="businessButtons[2].action">
            ...
            <div v-if="isMainMenuEnabled" :key="'achievements'" class="btn_container"
                :style="{ animationDelay: '0.3s' }">
                <div class="icon_container"
                    :class="{ 'icon_container--pulse': hasAchievementsReward && showAchievementsReminder }"
                    @click="businessButtons[3].action">
                    <img class="icon icon_achievement"
                        src="@/assets/images/cube_buttons/btn_desktop_achievements.svg" />
        ...
        <TransitionGroup name="business_tab_showing" tag="div" class="combat_inventory" aria-label="Боезапас и броня">
            <div v-if="isMainMenuEnabled" :key="'combat-ammo'"
                class="btn_container combat_inventory__item combat_inventory__item--ammo">
                <div class="icon_container combat_inventory__icon">
                    <img class="icon" src="@/assets/images/hud/cube_bullet.svg" alt="Патроны" />
                </div>
                <div class="btn_hint combat_inventory__value">{{ playerStore.ammo }}/{{ playerStore.maxAmmo }}</div>
            </div>

            <div v-if="isMainMenuEnabled" :key="'combat-armor'"
                class="btn_container combat_inventory__item combat_inventory__item--armor">
                <div class="icon_container combat_inventory__icon">
                    <img class="icon" src="@/assets/images/hud/cube_armor.svg" alt="Броня" />
                </div>
...
.combat_inventory {
    ...
    &__item--ammo .combat_inventory__value {
        color: $color-red-light;
    }

    &__item--armor .combat_inventory__value {
        color: $color-white;
    }
}
