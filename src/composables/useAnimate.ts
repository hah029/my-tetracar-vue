  ...
  debugCollider?: DebugColliderVisualizer,
    ...
    function animate(time: number) {
        ...
        if (
            ...
            if (!isGameOver) {
                if (playerStore.baseSpeed < playerStore.BASE_SPEED) playerStore.baseSpeed = playerStore.BASE_SPEED;
                playerStore.baseSpeed += playerStore.getCurrentAcceleration();
                if (playerStore.baseSpeed > playerStore.maxSpeed) playerStore.baseSpeed = playerStore.maxSpeed;
            };
