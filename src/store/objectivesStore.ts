...
export const useObjectivesStore = defineStore("objectivesStore", () => {
    ...
    const dailyObjectives = computed(() => DAILY_OBJECTIVES);   // массив всех ежедневных заданий
    ...
    // возвращает текущий прогресс по заданию
    ...
    // проверяет, получена ли награда за задание
    ...
    // задание можно завершить (прогресс >= target и ещё не получена награда)
