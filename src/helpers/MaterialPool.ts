...
import { loadTexture, type TextureOptions } from '@/helpers/loaders/loadTexture';
...
class MaterialPoolClass {
    ...
    getGoldenMaterial(): THREE.Material {
        return this.getMaterial({
            ...
            key: 'golden_coin',
            textureUrl: useCommonStore().GOLDEN_MATERIAL_CONFIG.textureUrl,
            emissive: useCommonStore().GOLDEN_MATERIAL_CONFIG.emissive,
            emissiveIntensity: useCommonStore().GOLDEN_MATERIAL_CONFIG.emissiveIntensity,
        });
    }
